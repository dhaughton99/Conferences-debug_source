...
public class InAppBrowser extends CordovaPlugin {
    ...
    class C00781 implements Runnable {
        ...
        C00781(String str, String str2, HashMap hashMap, CallbackContext callbackContext) {
            this.val$target = str;
            this.val$url = str2;
            ...
            if (InAppBrowser.SELF.equals(this.val$target)) {
                ...
                if (Boolean.TRUE.equals(shouldAllowNavigation)) {
                    ...
                    try {
                        ...
                        LOG.m3e(InAppBrowser.LOG_TAG, "Error dialing " + this.val$url + ": " + e7.toString());
                    }
                } else {
    ...
    class C00824 implements Runnable {
        ...
        class C00811 extends WebViewClient {
            C00811() {
            }
    ...
    class C00875 implements Runnable {
        ...
        class C00853 implements OnKeyListener {
            C00853() {
            }
        ...
        C00875(String str, CordovaWebView cordovaWebView) {
            this.val$url = str;
        ...
        public void run() {
            ...
            back.setOnClickListener(new C00831());
            ...
            linearLayout.setOnClickListener(new C00842());
            ...
            InAppBrowser.this.edittext.setOnKeyListener(new C00853());
            ...
            close.setOnClickListener(new C00864());
    ...
    public boolean execute(String action, CordovaArgs args, CallbackContext callbackContext) throws JSONException {
        if (action.equals("open")) {
            ...
            this.cordova.getActivity().runOnUiThread(new C00781(target, url, features, callbackContext));
            ...
            this.cordova.getActivity().runOnUiThread(new C00792());
    ...
    private void injectDeferredObject(String source, String jsWrapper) {
        ...
        this.cordova.getActivity().runOnUiThread(new C00803(scriptToInject));
    }
    ...
    public void closeDialog() {
        ...
        if (childView != null) {
            this.cordova.getActivity().runOnUiThread(new C00824(childView));
            try {
                JSONObject obj = new JSONObject();
    ...
    public String showWebPage(String url, HashMap<String, Boolean> features) {
        ...
        this.cordova.getActivity().runOnUiThread(new C00875(url, this.webView));
        return "";
    }
