...
public class FileUtils extends CordovaPlugin {
    ...
    class C01011 implements FileOp {
        final /* synthetic */ CallbackContext val$callbackContext;

        C01011(CallbackContext callbackContext) {
            this.val$callbackContext = callbackContext;
        }
    ...
    class C01022 implements FileOp {
        final /* synthetic */ CallbackContext val$callbackContext;

        C01022(CallbackContext callbackContext) {
            this.val$callbackContext = callbackContext;
        }
    ...
    class C01033 implements FileOp {
        final /* synthetic */ CallbackContext val$callbackContext;
        final /* synthetic */ String val$fname;

        C01033(String str, CallbackContext callbackContext) {
            this.val$fname = str;
            this.val$callbackContext = callbackContext;
        }
    ...
    class C01044 implements FileOp {
        final /* synthetic */ CallbackContext val$callbackContext;
        final /* synthetic */ String val$fname;

        C01044(String str, CallbackContext callbackContext) {
            this.val$fname = str;
            this.val$callbackContext = callbackContext;
        }
    ...
    class C01055 implements FileOp {
        final /* synthetic */ CallbackContext val$callbackContext;
        final /* synthetic */ String val$encoding;
        ...
        C01055(String str, int i, int i2, CallbackContext callbackContext, String str2) {
            this.val$fname = str;
            this.val$start = i;
            this.val$end = i2;
            this.val$callbackContext = callbackContext;
    ...
    class C01066 implements FileOp {
        final /* synthetic */ CallbackContext val$callbackContext;
        final /* synthetic */ int val$end;
        final /* synthetic */ String val$fname;
        final /* synthetic */ int val$start;

        C01066(String str, int i, int i2, CallbackContext callbackContext) {
            this.val$fname = str;
            this.val$start = i;
            this.val$end = i2;
            this.val$callbackContext = callbackContext;
    ...
    class C01077 implements FileOp {
        final /* synthetic */ CallbackContext val$callbackContext;
        final /* synthetic */ int val$end;
        final /* synthetic */ String val$fname;
        final /* synthetic */ int val$start;

        C01077(String str, int i, int i2, CallbackContext callbackContext) {
            this.val$fname = str;
            this.val$start = i;
            this.val$end = i2;
            this.val$callbackContext = callbackContext;
    ...
    class C01088 implements FileOp {
        final /* synthetic */ CallbackContext val$callbackContext;
        final /* synthetic */ int val$end;
        final /* synthetic */ String val$fname;
        final /* synthetic */ int val$start;

        C01088(String str, int i, int i2, CallbackContext callbackContext) {
            this.val$fname = str;
            this.val$start = i;
            this.val$end = i2;
            this.val$callbackContext = callbackContext;
    ...
    class C01099 implements FileOp {
        final /* synthetic */ CallbackContext val$callbackContext;
        ...
        C01099(String str, String str2, int i, Boolean bool, CallbackContext callbackContext) {
            this.val$fname = str;
            this.val$data = str2;
            this.val$offset = i;
    ...
    public boolean execute(String action, JSONArray args, CallbackContext callbackContext) throws JSONException {
        if (this.configured) {
            if (action.equals("testSaveLocationExists")) {
                threadhelper(new C01011(callbackContext), callbackContext);
            } else {
                if (action.equals("getFreeDiskSpace")) {
                    threadhelper(new C01022(callbackContext), callbackContext);
                } else {
                    if (action.equals("testFileExists")) {
                        threadhelper(new C01033(args.getString(0), callbackContext), callbackContext);
                    } else {
                        if (action.equals("testDirectoryExists")) {
                            threadhelper(new C01044(args.getString(0), callbackContext), callbackContext);
                        } else {
                            if (action.equals("readAsText")) {
                                String encoding = args.getString(1);
                                threadhelper(new C01055(args.getString(0), args.getInt(2), args.getInt(3), callbackContext, encoding), callbackContext);
                            } else {
                                if (action.equals("readAsDataURL")) {
                                    threadhelper(new C01066(args.getString(0), args.getInt(1), args.getInt(2), callbackContext), callbackContext);
                                } else {
                                    if (action.equals("readAsArrayBuffer")) {
                                        threadhelper(new C01077(args.getString(0), args.getInt(1), args.getInt(2), callbackContext), callbackContext);
                                    } else {
                                        if (action.equals("readAsBinaryString")) {
                                            threadhelper(new C01088(args.getString(0), args.getInt(1), args.getInt(2), callbackContext), callbackContext);
                                        } else {
                                            if (action.equals("write")) {
                                                String string = args.getString(0);
                                                threadhelper(new C01099(fname, args.getString(1), args.getInt(2), Boolean.valueOf(args.getBoolean(3)), callbackContext), callbackContext);
                                            } else {
    ...
    private JSONArray requestAllFileSystems() throws IOException, JSONException {
        ...
        Iterator i$ = this.filesystems.iterator();
        while (i$.hasNext()) {
            ret.put(((Filesystem) i$.next()).getRootEntry());
        }
        return ret;
    }
