...
public final class HttpTransport implements Transport {
    ...
    public OutputStream createRequestBody() throws IOException {
        ...
        int fixedContentLength = this.httpEngine.policy.getFixedContentLength();
        ...
        int contentLength = this.httpEngine.requestHeaders.getContentLength();
        if (contentLength == -1) {
    ...
    public ResponseHeaders readResponseHeaders() throws IOException {
        RawHeaders headers = RawHeaders.fromBytes(this.socketIn);
        this.httpEngine.connection.setHttpMinorVersion(headers.getHttpMinorVersion());
        this.httpEngine.receiveHeaders(headers);
        return new ResponseHeaders(this.httpEngine.uri, headers);
    }
