...
public final class RawHeaders {
    ...
    static class C00171 implements Comparator<String> {
        C00171() {
        }
    ...
    static {
        FIELD_NAME_COMPARATOR = new C00171();
    }
    ...
    public void computeResponseStatusLineFromSpdyHeaders() throws IOException {
        ...
        for (int i = 0; i < this.namesAndValues.size(); i += 2) {
            String name = (String) this.namesAndValues.get(i);
            if (":status".equals(name)) {
                status = (String) this.namesAndValues.get(i + 1);
            } else if (":version".equals(name)) {
                version = (String) this.namesAndValues.get(i + 1);
            }
        }
